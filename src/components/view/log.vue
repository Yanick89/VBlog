      ...
      <div v-if="showModalSignUp" :class="{isActive}">
        <div class="log">
          ...
          <div class="formulaire">         
            ...
            <div class="submit">
              <button type="submit" @click.prevent="signUp()"> Enregister</button>
            </div>        
          </div>
      ...
      <div v-if="showModalSignIn" :class="{isActive}">
        <div class="log">
          ...
          <div class="formulaire">         
            <label for="mail">
              Email:
              <input type="email" v-model="connectUser.email" id="mail" placeholder="mouzx@y.com" autocomplete="email">
            </label>
            <label for="password">
              Mot de passe:
              <input type="password" v-model="connectUser.passWord" id="password" placeholder="mot de passe" autocomplete="current-password">
            </label>
            <div class="submit">
              <button type="submit" @click.prevent="signIn"> Connexion</button>
            </div>         
          </div>
          <div class="description">
